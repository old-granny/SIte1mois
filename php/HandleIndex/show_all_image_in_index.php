     ...
     for ($i=0; $i<count($files); $i++)
      {
        ...
        $supported_file = array(
         ...
         if (in_array($ext, $supported_file)) {
            ...
            echo "<div class=colonne$colonne> <div class=ranger$ranger>", "<h4>$nomPourPresenter</h4>", "<br>" , '<a href="selling_pages/'.$nom_pour_cree_page.'"> <img src="'.$image .'" alt="Random image" class="images"/></a> <button onclick="AddToCart('.$id.')"> add to shopping cart</button> '."<h5 style=\" position: relative; left : 160px; top: -35px;\">$prix : price </h5> <br/><br/></div></div>";
            $ranger++;
            if($ranger == 5){
              $colonne++;
              $ranger = 1;
